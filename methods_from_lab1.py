...
def gradient_descent_with_constant_step(f, x, step=0.001, max_iter=10000, eps=1e-6):
    ...
    for k in range(max_iter):
        ...
        x = x - step * grad
    # print(
        # f"gradient_descent_with_constant_step: iterations: {k + 1}, grad: {tracker.g}, hes: {tracker.h}, f: {tracker.f}")
    return x
...
def gradient_descent_with_golden_section(f, x, a=0, b=0.1, max_iter=10000, eps=1e-6):
    ...
    for k in range(max_iter):
        ...
        x = x - step * grad
    # print(
        # f"gradient_descent_with_golden_section: iterations: {k + 1}, grad: {tracker.g}, hes: {tracker.h}, f: {tracker.f}")
    return x
